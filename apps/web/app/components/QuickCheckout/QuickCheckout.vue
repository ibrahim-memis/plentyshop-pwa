          ...
          <div class="shrink-0 border-t border-neutral-200">
            ...
            <div class="px-5 pb-3 space-y-2">
              <div class="flex justify-between text-sm">
                <span class="text-neutral-600">{{ t('quickCheckout.cartValue') }} ({{ showNetPrices ? t('common.labels.grossPrice') : t('common.labels.grossPrice') }})</span>
                <span class="font-medium text-neutral-900">{{ format(totals.subTotal) }}</span>
              </div>
              <div class="flex justify-between text-sm">
                <span class="text-neutral-600">{{ t('quickCheckout.shippingCosts') }} ({{ showNetPrices ? t('common.labels.grossPrice') : t('common.labels.grossPrice') }})</span>
