export default {
  ...
  metaTitle: process.env.NUXT_PUBLIC_META_TITLE || process.env.METATITLE || 'Gastronomiebedarf günstig online kaufen',
  ...
  primaryColor: process.env.NUXT_PUBLIC_PRIMARY_COLOR || '#384d37',
  ...
  secondaryColor: process.env.NUXT_PUBLIC_SECONDARY_COLOR || '#4a6349',
  headerBackgroundColor:
    process.env.NUXT_PUBLIC_HEADER_BACKGROUND_COLOR || process.env.NUXT_PUBLIC_PRIMARY_COLOR || '#FFFFFF',
  iconColor: process.env.NUXT_PUBLIC_ICON_COLOR || '#384d37',
